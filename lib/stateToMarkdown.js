...
var _draftJsUtils2 = require('draft-js-utils');

var _draftJs = require('draft-js');

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var BOLD = _draftJsUtils2.INLINE_STYLE.BOLD;
var CODE = _draftJsUtils2.INLINE_STYLE.CODE;
var ITALIC = _draftJsUtils2.INLINE_STYLE.ITALIC;
var STRIKETHROUGH = _draftJsUtils2.INLINE_STYLE.STRIKETHROUGH;
var UNDERLINE = _draftJsUtils2.INLINE_STYLE.UNDERLINE;
...
var MarkupGenerator = function () {
  ...
  _createClass(MarkupGenerator, [{
    ...
    value: function processBlock() {
      ...
      switch (blockType) {
        case _draftJsUtils2.BLOCK_TYPE.HEADER_ONE:
          {
            this.insertLineBreaks(1);
            this.output.push('# ' + this.renderBlockContent(block) + '\n');
            break;
          }
        case _draftJsUtils2.BLOCK_TYPE.HEADER_TWO:
          {
            this.insertLineBreaks(1);
            this.output.push('## ' + this.renderBlockContent(block) + '\n');
            break;
          }
        case _draftJsUtils2.BLOCK_TYPE.HEADER_THREE:
          {
            this.insertLineBreaks(1);
            this.output.push('### ' + this.renderBlockContent(block) + '\n');
            break;
          }
        case _draftJsUtils2.BLOCK_TYPE.HEADER_FOUR:
          {
            this.insertLineBreaks(1);
            this.output.push('#### ' + this.renderBlockContent(block) + '\n');
            break;
          }
        case _draftJsUtils2.BLOCK_TYPE.HEADER_FIVE:
          {
            this.insertLineBreaks(1);
            this.output.push('##### ' + this.renderBlockContent(block) + '\n');
            break;
          }
        case _draftJsUtils2.BLOCK_TYPE.HEADER_SIX:
          {
            this.insertLineBreaks(1);
            this.output.push('###### ' + this.renderBlockContent(block) + '\n');
            break;
          }
        case _draftJsUtils2.BLOCK_TYPE.UNORDERED_LIST_ITEM:
          {
            ...
            if (lastBlockType !== blockType && lastBlockDepth !== blockDepth - 1) {
              ...
              if (lastBlockType === _draftJsUtils2.BLOCK_TYPE.ORDERED_LIST_ITEM) {
                this.insertLineBreaks(1);
              }
            }
        ...
        case _draftJsUtils2.BLOCK_TYPE.ORDERED_LIST_ITEM:
          {
            ...
            if (_lastBlockType !== blockType && _lastBlockDepth !== _blockDepth - 1) {
              this.insertLineBreaks(1);
              // Insert an additional line break if following opposite list type.
              if (_lastBlockType === _draftJsUtils2.BLOCK_TYPE.UNORDERED_LIST_ITEM) {
                this.insertLineBreaks(1);
              }
            }
        ...
        case _draftJsUtils2.BLOCK_TYPE.BLOCKQUOTE:
          {
            this.insertLineBreaks(1);
            this.output.push(' > ' + this.renderBlockContent(block) + '\n');
            break;
          }
        case _draftJsUtils2.BLOCK_TYPE.CODE:
          {
            this.insertLineBreaks(1);
    ...
    value: function renderBlockContent(block) {
      ...
      var entityPieces = (0, _draftJsUtils2.getEntityRanges)(text, charMetaList);
      return entityPieces.map(function (_ref) {
        ...
        var content = stylePieces.map(function (_ref3) {
          ...
          if (style.has(CODE)) {
            content = blockType === _draftJsUtils2.BLOCK_TYPE.CODE ? content : '`' + content + '`';
          }
          return content;
        }).join('');
        var entity = entityKey ? _draftJs.Entity.get(entityKey) : null;
        if (entity != null && entity.getType().toLowerCase() === _draftJsUtils2.ENTITY_TYPE.LINK.toLowerCase()) {
